    ...
    return <>
        ...
        <form className="ls-form" onSubmit={(e) => {HandleSignIn(e)}}>
            ...
            <div id="terms-conditions">
                ...
                <p><em>PS: Our site uses two cookies to handle light/dark mode and user context that are created when you sign up/log in, and subsequently removes the context cookie when logging out (so by signing up/loging in you agree to the use of these cookies).</em></p><br/>
